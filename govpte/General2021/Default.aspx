<%@ Page Title="" Language="C#" MasterPageFile="~/ElectionDay.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="govpte.General2021" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <asp:UpdatePanel ID="updatePanelPage" runat="server" UpdateMode="Conditional" >
        ...
        <p>
            <a target="_blank" href="https://electionresults.macombgov.org/m33/results.html">Official Macomb County Website - Race List</a>
        </p>
