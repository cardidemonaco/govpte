            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    foreach (HtmlNode hnRace in hncRaces)
                    {
                        ...
                        //IEnumerable<HtmlNode> hncCandidates = hnRace.SelectNodes($"/table[{i}]//*[@class=\"candname\"]");
                        ...
                        //HtmlNodeCollection hncCandidatesVoteTotals = hnRace.SelectNodes($"/table[{i}]//*[@class=\"vtotal\"]");
                        int sum = 0;
